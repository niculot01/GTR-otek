...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="order.php" class="nav-link">Stock Out</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="addproducts.php" class="nav-link">Stock in</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link">
      <img src="GTR_logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="registration.php" class="d-block">Welcome <?php echo $_SESSION['username'];?></a>
        </div>
      </div>
