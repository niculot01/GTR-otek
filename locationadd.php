                  ...
                  <?php
                    if(isset($_POST["btnedit"])){
                      ...
                      echo'
                        ...
                        <input type="text" class="form-control" placeholder=" Enter Location name " name="txtloc" >
                        </div>';      
                    }
                  ?>  
                </div>
                  ...
                  <?php
                    ...
                    while($row=$selectloc->fetch(PDO::FETCH_OBJ)){  
                      echo "  
                        ...
                        <td>$row->locid</td>
                        <td>$row->loc</td>
                        <td><button type=\"submit\" value=\" \".$row->locid\"\"  
                          class=\"btn btn-success\" name=\"btnedit\">EDIT</button></td>
                        <td><button type=\"submit\" value=\" \".$row->locid\"\"  
                          class=\"btn btn-danger\" name=\"btndelete\">DELETE</button></td>
                        </tr>";    
                    }
                  ?>
                </tbody>
