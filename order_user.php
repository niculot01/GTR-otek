...
if(isset($_POST["btnsaveorder"])){
   // $datee=$_POST['orderdate'];
    ...
    $insert=$pdo->prepare("insert into tbl_invoice(customer_name,order_date,order_time,subtotal,tax,discount,total,paid,due,payment_type) 
    values(:cust,:orderdate,:ordertime,:stotal,:tax,:disc,:total,:paid,:due,:ptype)");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Stock Out Form</h1>
